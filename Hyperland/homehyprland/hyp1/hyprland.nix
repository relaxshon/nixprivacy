...
#exec-once = mullvad relay set tunnel-protocol wireguard & mullvad obfuscation set mode udp2tcp & mullvad tunnel set wireguard --quantum-resistant on & mullvad relay set ownership 'owned' & mullvad api-access enable 2 & mullvad api-access disable 1
...
$delete = rm -rf /home/user/.librewolf && rm -rf /home/user/.mullvad
...
bind = $mainMod, S, exec, $stremio # stremio
bind = ALT, Q, exec, shutdown -h 0 # shutdown system fast
bind = ALT, D, exec, $delete # remove profile for librewolf and mullvad this help to remove trackers
