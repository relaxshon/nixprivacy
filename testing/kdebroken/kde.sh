...
pprint "Mouting cryptroot on /mnt"
...
mount -t tmpfs -o size=2G,mode=755,nosuid,nodev none /mnt
mkdir -p /mnt
mkdir -p /mnt/{nix,home,boot}
mkdir -p /mnt/home/user
mount -t tmpfs -o size=2G,mode=755,noatime,nosuid,nodev none /mnt/home/user
